...
import co.unicauca.restaurante.cliente.infra.UserSocket;
...
public class UserAccessImplSockets implements IUserAccess{
     ...
     */
    private final UserSocket mySocket;
     ...
     */
    private String findUserRequestJson(String userLoginName) {
        Protocol protocol = new Protocol();
        protocol.setResource("user");
        protocol.setAction("get");
        protocol.addParameter("userLoginName", userLoginName);
    ...
    private String createUserRequestJson(User user) {
        ...
        protocol.addParameter("userLoginName", user.getUserLoginName());
        protocol.addParameter("userPassword", user.getUserPassword());
        protocol.addParameter("userName", user.getUserName());
        protocol.addParameter("userLastName", user.getUserLastName());
        protocol.addParameter("userAddress", user.getUserAddres());
        protocol.addParameter("userMobile", user.getUserMobile());
        protocol.addParameter("userEmail", user.getUserEmail());
